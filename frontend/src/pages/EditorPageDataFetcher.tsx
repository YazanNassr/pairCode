import { Project, ProjectEditorState } from "../types/types.ts";
...
export default function EditorPageDataFetcher() {
    ...
    if (error) {
        return (
            <Box sx={{ textAlign: "center" }}>
                <Typography variant={"h3"} sx={{ color: "error.main", m: 5 }}>
    ...
    if (!isSuccess) {
        return (
            <Typography variant={"h3"} sx={{ color: "primary.dark", textAlign: "center", m: 5 }}>
                Loading...
            </Typography>
        );
    }
    ...
    if (data) {
        ...
        return (
            <RequireAuth>
                ...
                >
                    <EditorPage initialState={editorState} />
                </StompSessionProvider>
            </RequireAuth>
        );
    }
